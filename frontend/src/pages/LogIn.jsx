    ...
    <main className="md:min-h-screen flex items-center justify-center py-4 px-4 md:px-8">
      <div
        ...
        <div className="grid items-center w-full gap-4 md:grid-cols-2">
          <div
            className="hidden md:block bg-gray-50 relative before:absolute before:inset-0 before:bg-black/40 overflow-hidden w-full h-full">
            <img src={sideimg} className="w-full h-full object-cover" alt="login image" />
          ...
          <div className="py-6 px-6 lg:px-8 max-md:-order-1">
            <div className="max-w-md mx-auto w-full">
              ...
              <div className="mt-6 text-slate-900 text-sm text-center dark:text-slate-50">Don't have an account? <Link to="/signup"
